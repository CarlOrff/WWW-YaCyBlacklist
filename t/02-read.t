...
my $black1 = 'C:/Users/Work/Documents/ingram/Perl/dzil/WWW-YaCyBlacklist/yacy/url.default.black';
my $black2 = "C:/Users/Work/Documents/ingram/Perl/dzil/WWW-YaCyBlacklist/yacy/url.ib-mirrors.black";
$ycb = WWW::YaCyBlacklist->new( 'use_regex' => 1 );
$ycb->read_from_files($black1,$black2);
cmp_ok( $ycb->lines, '>', 0, 'lines_cmp' );
like( $ycb->lines, '/\d{5}/', 'lines_like' );
